...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer, ProcessPointClouds<pcl::PointXYZI>* pointProcessorI, const pcl::PointCloud<pcl::PointXYZI>::Ptr& inputCloud)
{
	...
	/*Segmentation: Segment the scene to create to clouds one for road and another for objects.*/
	std::pair<pcl::PointCloud<pcl::PointXYZI>::Ptr, pcl::PointCloud<pcl::PointXYZI>::Ptr> segmentCloud = pointProcessorI->SegmentPlane_RANSAC(filterCloud, 50, 0.2);  /// SegmentPlane_RANSAC function implements RANSAC function from scratch
...
int main (int argc, char** argv)
{
    ...
    CameraAngle setAngle = XY;  // defined enum in render.h
